// /////////////////////////////////////////////////////////////
// File: KeyboardHookExt.cs	Class: ManagedHooks.KeyboardHookExt
...
namespace ManagedHooks
{
	...
	public class KeyboardHookExt : KeyboardHook
	{
		...
		private void KeyboardHookExt_KeyboardEvent(ManagedHooks.KeyboardEvents kEvent, System.Windows.Forms.Keys key)
		{
			switch (kEvent)
			{
