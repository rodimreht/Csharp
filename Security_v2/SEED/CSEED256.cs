...
namespace PnPeople.Security
{
	public class SEED256
	{
		...
		/// SEED 암호키 크기: 256bit
		/// </summary>
		public const int SEED_USER_KEY_LEN = 0x20; //	in BYTEs
		...
		/// <summary>
		/// SEED NO ROUNDS: 256bit
		/// </summary>
		public const int SEED_NO_ROUNDS = 0x18;
		...
		private const uint KC16 = 0x79b99e37;
		private const uint KC17 = 0xf3733c6e;
		private const uint KC18 = 0xe6e678dd;
		private const uint KC19 = 0xcdccf1bb;
		private const uint KC20 = 0x9b99e377;
		private const uint KC21 = 0x3733c6ef;
		private const uint KC22 = 0x6e678dde;
		private const uint KC23 = 0xdccf1bbc;
		...
		private static void EncRoundKeyUpdate0(ref uint[] K, int offset, ref uint A, ref uint B, ref uint C, ref uint D,
			uint E, uint F, uint G, uint H, uint KC, int rot)
		{
			uint T0 = D;
			D = (D >> rot) ^ (C << (32 - rot));
			C = (C >> rot) ^ (B << (32 - rot));
			...
			T0 = (((A + C) ^ E) - F) ^ KC;
			uint T1 = (((B - D) ^ G) + H) ^ KC;
			K[offset + 0] = SS0[T0 & 0xFF] ^ SS1[(T0 >> 8) & 0xFF] ^ SS2[(T0 >> 16) & 0xFF] ^ SS3[(T0 >> 24) & 0xFF];
			K[offset + 1] = SS0[T1 & 0xFF] ^ SS1[(T1 >> 8) & 0xFF] ^ SS2[(T1 >> 16) & 0xFF] ^ SS3[(T1 >> 24) & 0xFF];
		}

		private static void EncRoundKeyUpdate1(ref uint[] K, int offset, uint A, uint B, uint C, uint D, ref uint E,
			ref uint F, ref uint G, ref uint H, uint KC, int rot)
		{
			uint T0 = E;
			E = (E << rot) ^ (F >> (32 - rot));
			F = (F << rot) ^ (G >> (32 - rot));
		...
		{
			uint A = 0, B = 0, C = 0, D = 0, E = 0, F = 0, G = 0, H = 0, T0 = 0, T1 = 0;
			...
			BIG_B2D(UserKey, 16, ref E);
			BIG_B2D(UserKey, 20, ref F);
			BIG_B2D(UserKey, 24, ref G);
			BIG_B2D(UserKey, 28, ref H);

			T0 = (((A + C) ^ E) - F) ^ KC0;
			T1 = (((B - D) ^ G) + H) ^ KC0;
			K[0] = SS0[T0 & 0xFF] ^ SS1[(T0 >> 8) & 0xFF]
			       ^ SS2[(T0 >> 16) & 0xFF] ^ SS3[(T0 >> 24) & 0xFF];
			K[1] = SS0[T1 & 0xFF] ^ SS1[(T1 >> 8) & 0xFF]
			       ^ SS2[(T1 >> 16) & 0xFF] ^ SS3[(T1 >> 24) & 0xFF];

			EncRoundKeyUpdate0(ref K, 2, ref A, ref B, ref C, ref D, E, F, G, H, KC1, 9);
			EncRoundKeyUpdate1(ref K, 4, A, B, C, D, ref E, ref F, ref G, ref H, KC2, 9);
			EncRoundKeyUpdate0(ref K, 6, ref A, ref B, ref C, ref D, E, F, G, H, KC3, 11);
			EncRoundKeyUpdate1(ref K, 8, A, B, C, D, ref E, ref F, ref G, ref H, KC4, 11);
			EncRoundKeyUpdate0(ref K, 10, ref A, ref B, ref C, ref D, E, F, G, H, KC5, 12);
			EncRoundKeyUpdate1(ref K, 12, A, B, C, D, ref E, ref F, ref G, ref H, KC6, 12);
			EncRoundKeyUpdate0(ref K, 14, ref A, ref B, ref C, ref D, E, F, G, H, KC7, 9);
			EncRoundKeyUpdate1(ref K, 16, A, B, C, D, ref E, ref F, ref G, ref H, KC8, 9);
			EncRoundKeyUpdate0(ref K, 18, ref A, ref B, ref C, ref D, E, F, G, H, KC9, 11);
			EncRoundKeyUpdate1(ref K, 20, A, B, C, D, ref E, ref F, ref G, ref H, KC10, 11);
			EncRoundKeyUpdate0(ref K, 22, ref A, ref B, ref C, ref D, E, F, G, H, KC11, 12);
			EncRoundKeyUpdate1(ref K, 24, A, B, C, D, ref E, ref F, ref G, ref H, KC12, 12);
			EncRoundKeyUpdate0(ref K, 26, ref A, ref B, ref C, ref D, E, F, G, H, KC13, 9);
			EncRoundKeyUpdate1(ref K, 28, A, B, C, D, ref E, ref F, ref G, ref H, KC14, 9);
			EncRoundKeyUpdate0(ref K, 30, ref A, ref B, ref C, ref D, E, F, G, H, KC15, 11);
			EncRoundKeyUpdate1(ref K, 32, A, B, C, D, ref E, ref F, ref G, ref H, KC16, 11);
			EncRoundKeyUpdate0(ref K, 34, ref A, ref B, ref C, ref D, E, F, G, H, KC17, 12);
			EncRoundKeyUpdate1(ref K, 36, A, B, C, D, ref E, ref F, ref G, ref H, KC18, 12);
			EncRoundKeyUpdate0(ref K, 38, ref A, ref B, ref C, ref D, E, F, G, H, KC19, 9);
			EncRoundKeyUpdate1(ref K, 40, A, B, C, D, ref E, ref F, ref G, ref H, KC20, 9);
			EncRoundKeyUpdate0(ref K, 42, ref A, ref B, ref C, ref D, E, F, G, H, KC21, 11);
			EncRoundKeyUpdate1(ref K, 44, A, B, C, D, ref E, ref F, ref G, ref H, KC22, 11);
			EncRoundKeyUpdate0(ref K, 46, ref A, ref B, ref C, ref D, E, F, G, H, KC23, 12);

			//	Remove sensitive data
			A = B = C = D = E = F = G = H = T0 = T1 = 0;
			algoInfo.RoundKey = K;
			K = null;
		...
		private static void SeedRound(ref uint A, ref uint B, uint C, uint D, uint[] K, int offset)
		{
			...
			T1 = D ^ K[offset + 1];
			T1 ^= T0;
			T1 = SS0[T1 & 0xFF] ^ SS1[(T1 >> 8) & 0xFF]
			     ^ SS2[(T1 >> 16) & 0xFF] ^ SS3[(T1 >> 24) & 0xFF];
			T0 += T1;
			T0 = SS0[T0 & 0xFF] ^ SS1[(T0 >> 8) & 0xFF]
			     ^ SS2[(T0 >> 16) & 0xFF] ^ SS3[(T0 >> 24) & 0xFF];
			T1 += T0;
			T1 = SS0[T1 & 0xFF] ^ SS1[(T1 >> 8) & 0xFF]
			     ^ SS2[(T1 >> 16) & 0xFF] ^ SS3[(T1 >> 24) & 0xFF];
			...
			int offset)
		{
			...
			SeedRound(ref A, ref B, C, D, K, 32);
			SeedRound(ref C, ref D, A, B, K, 34);
			SeedRound(ref A, ref B, C, D, K, 36);
			SeedRound(ref C, ref D, A, B, K, 38);
			SeedRound(ref A, ref B, C, D, K, 40);
			SeedRound(ref C, ref D, A, B, K, 42);
			SeedRound(ref A, ref B, C, D, K, 44);
			SeedRound(ref C, ref D, A, B, K, 46);
			...
			int offset)
		{
			...
			//
			SeedRound(ref A, ref B, C, D, K, 46);
			SeedRound(ref C, ref D, A, B, K, 44);
			SeedRound(ref A, ref B, C, D, K, 42);
			SeedRound(ref C, ref D, A, B, K, 40);
			SeedRound(ref A, ref B, C, D, K, 38);
			SeedRound(ref C, ref D, A, B, K, 36);
			SeedRound(ref A, ref B, C, D, K, 34);
			SeedRound(ref C, ref D, A, B, K, 32);
		...
		private static void BlockXor(ref byte[] dst, int offset, byte[] src1, byte[] src2)
		{
			for (int i = 0; i < SEED_BLOCK_LEN; i += 4)
			{
				Buffer.BlockCopy(BitConverter.GetBytes(BitConverter.ToUInt32(src1, i) ^ BitConverter.ToUInt32(src2, i)), 0, dst,
					offset + i, 4);
			}
		}
			...
			ref byte[] cipherText, ref uint cipherTextLen)
		{
			...
			{
				case MODE.AI_ECB:
					return ECB_EncUpdate(ref algoInfo, plainText, plainTextLen, ref cipherText, ref cipherTextLen);
				case MODE.AI_CBC:
					return CBC_EncUpdate(ref algoInfo, plainText, plainTextLen, ref cipherText, ref cipherTextLen);
				case MODE.AI_OFB:
					return OFB_EncUpdate(ref algoInfo, plainText, plainTextLen, ref cipherText, ref cipherTextLen);
				case MODE.AI_CFB:
					return CFB_EncUpdate(ref algoInfo, plainText, plainTextLen, ref cipherText, ref cipherTextLen);
				default:
					return CODE.CTR_FATAL_ERROR;
			}
		}

		private static CODE SEED_EncFinal(ref SEED_ALG_INFO algoInfo, ref byte[] cipherText, int offset,
			ref uint cipherTextLen)
		{
			switch (algoInfo.ModeID)
			{
				case MODE.AI_ECB:
					return ECB_EncFinal(ref algoInfo, ref cipherText, offset, ref cipherTextLen);
				case MODE.AI_CBC:
					return CBC_EncFinal(ref algoInfo, ref cipherText, offset, ref cipherTextLen);
				case MODE.AI_OFB:
					return OFB_EncFinal(ref algoInfo, ref cipherText, offset, ref cipherTextLen);
				case MODE.AI_CFB:
					return CFB_EncFinal(ref algoInfo, ref cipherText, offset, ref cipherTextLen);
				default:
					return CODE.CTR_FATAL_ERROR;
			}
		}
			...
			ref byte[] plainText, ref uint plainTextLen)
		{
			...
			{
				case MODE.AI_ECB:
					return ECB_DecUpdate(ref algoInfo, cipherText, cipherTextLen, ref plainText, ref plainTextLen);
				case MODE.AI_CBC:
					return CBC_DecUpdate(ref algoInfo, cipherText, cipherTextLen, ref plainText, ref plainTextLen);
				case MODE.AI_OFB:
					return OFB_DecUpdate(ref algoInfo, cipherText, cipherTextLen, ref plainText, ref plainTextLen);
				case MODE.AI_CFB:
					return CFB_DecUpdate(ref algoInfo, cipherText, cipherTextLen, ref plainText, ref plainTextLen);
				default:
					return CODE.CTR_FATAL_ERROR;
			}
		}
		...
		private static CODE SEED_DecFinal(ref SEED_ALG_INFO algoInfo, ref byte[] plainText, int offset, ref uint plainTextLen)
		{
			...
			{
				case MODE.AI_ECB:
					return ECB_DecFinal(ref algoInfo, ref plainText, offset, ref plainTextLen);
				case MODE.AI_CBC:
					return CBC_DecFinal(ref algoInfo, ref plainText, offset, ref plainTextLen);
				case MODE.AI_OFB:
					return OFB_DecFinal(ref algoInfo, ref plainText, offset, ref plainTextLen);
				case MODE.AI_CFB:
					return CFB_DecFinal(ref algoInfo, ref plainText, offset, ref plainTextLen);
				default:
					return CODE.CTR_FATAL_ERROR;
			}
		}
