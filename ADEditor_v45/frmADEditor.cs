...
namespace ADEditor
{
	...
	public partial class frmADEditor : Form
	{
	    ...
	    {
	        LdapServer2 s2 = new LdapServer2();
	        bool b = s2.Connect("192.168.0.101", 389, "pnpadmin@pnpeople.com", "pnp#1004", "OU=JuniperUsers,DC=kcb,DC=com");
	        string[] arr = {"displayName"};
	        if (!b) return;
            var a = s2.GetDirectoryEntry("CN=thermidor", arr);
	        s2.SetProperty(a.DistinguishedName, "userPassword", "!2qwaszx");
	        //s2.SetPassword(a.DistinguishedName, "!2qwaszx");
	    }
