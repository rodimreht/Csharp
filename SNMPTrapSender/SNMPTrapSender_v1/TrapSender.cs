...
namespace SNMPTrapSenderv1
{
	...
	public class TrapSender
	{
		...
		/// <param name="varBind">Variable Bindings: FixedVariable 형식의 List 객체</param>
		public void Send(uint[] trapOID, IList varBind)
		{
			IPAddress addr = Dns.GetHostByName(Dns.GetHostName()).AddressList[0];
		...
		/// <param name="trapOID">uint 정수 배열로 이루어진 트랩 메시지 OID</param>
		/// <param name="varBind">Variable Bindings: FixedVariable 형식의 List 객체</param>
		public void Send(string managerIPAddress, uint[] trapOID, IList varBind)
		{
			string community = "public";
		...
		/// <param name="trapOID">uint 정수 배열로 이루어진 트랩 메시지 OID</param>
		/// <param name="varBind">Variable Bindings: FixedVariable 형식의 List 객체</param>
		public void Send(string managerIPAddress, string community, uint[] trapOID, IList varBind)
		{
			IPAddress addr1 = IPAddress.Parse(managerIPAddress);
			IPAddress addr2 = Dns.GetHostByName(Dns.GetHostName()).AddressList[0];
			ObjectIdentifier trapOid = new ObjectIdentifier(trapOID);
		...
		/// <param name="trapOID">uint 정수 배열로 이루어진 트랩 메시지 OID</param>
		/// <param name="varBind">Variable Bindings: FixedVariable 형식의 List 객체</param>
		public void Send(string managerIPAddress, string agentIPAddress, string community, uint[] trapOID, IList varBind)
		{
			IPAddress addr1 = IPAddress.Parse(managerIPAddress);
		...
		/// <param name="trapOID">uint 정수 배열로 이루어진 트랩 메시지 OID</param>
		/// <param name="varBind">Variable Bindings: FixedVariable 형식의 List 객체</param>
		public void Send(IPAddress managerIPAddress, IPAddress agentIPAddress, string community, ObjectIdentifier trapOID, IList varBind)
		{
