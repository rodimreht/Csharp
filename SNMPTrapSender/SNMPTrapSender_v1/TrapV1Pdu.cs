...
namespace Lextm.SharpSnmpLib
{
    ...
    public class TrapV1Pdu : ISnmpPdu, ISnmpData
    {
        ...
        [CLSCompliant(false)]
        public TrapV1Pdu(uint[] enterprise, IP agent, Integer32 generic, Integer32 specific, TimeTicks timeStamp, IList variables)
        ...
        /// <param name="timeStamp">Time stamp</param>
        /// <param name="variables">Variable binds</param>
        public TrapV1Pdu(ObjectIdentifier enterprise, IP agent, Integer32 generic, Integer32 specific, TimeTicks timeStamp, IList variables)
        {
