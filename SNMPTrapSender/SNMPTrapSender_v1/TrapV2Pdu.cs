...
namespace Lextm.SharpSnmpLib
{
    ...
    public class TrapV2Pdu : ISnmpPdu
    {
        ...
        public TrapV2Pdu(Integer32 version, ObjectIdentifier enterprise, TimeTicks time, IList variables)
        {
            _enterprise = enterprise;
            _version = version;
            _time = time;
            _variables = variables;
            IList full = new ArrayList(variables);
        ...
        public TrapV2Pdu(byte[] raw)
        {
            ...
            _time = (TimeTicks)((Variable)_variables[0]).Data;
            _variables.RemoveAt(0);
            _enterprise = (ObjectIdentifier)((Variable)_variables[0]).Data;
            _variables.RemoveAt(0);
        }
