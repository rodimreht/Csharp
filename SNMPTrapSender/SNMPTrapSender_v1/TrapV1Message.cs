...
namespace Lextm.SharpSnmpLib
{
    ...
    public class TrapV1Message : ISnmpMessage, ISnmpData, IDisposable
    {
        ...
        public TrapV1Message(VersionCode version, IPAddress agent, string community, ObjectIdentifier enterprise, GenericCode generic, int specific, int time, IList variables)
        {
            _version = version;
            _agent = agent;
