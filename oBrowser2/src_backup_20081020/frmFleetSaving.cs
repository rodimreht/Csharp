...
namespace oBrowser2
{
	public partial class frmFleetSaving : Form
	{
		...
		public bool FleetSaving()
		{
			...
			Logger.Log("[플릿 세이빙] 자원 총량: " + resQuantity);
