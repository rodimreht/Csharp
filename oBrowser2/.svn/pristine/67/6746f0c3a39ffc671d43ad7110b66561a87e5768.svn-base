namespace oBrowser2
{
  partial class AboutForm
  {
    ...
    private void InitializeComponent()
    {
			...
			this.ccLicenseImage.Image = global::oBrowser2.Properties.Resources.cc;
			...
			// btnSMSTest
			// 
			this.btnSMSTest.DialogResult = System.Windows.Forms.DialogResult.Cancel;
			resources.ApplyResources(this.btnSMSTest, "btnSMSTest");
			this.btnSMSTest.Name = "btnSMSTest";
			this.btnSMSTest.UseVisualStyleBackColor = true;
			this.btnSMSTest.Click += new System.EventHandler(this.btnSMSTest_Click);
			// 
			// lblVersion
			// 
			...
			this.Controls.Add(this.btnSMSTest);
