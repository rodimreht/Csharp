namespace oBrowser2
{
	partial class LoginForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.cboUniX = new System.Windows.Forms.ComboBox();
			...
			// cboUniX
			// 
			this.cboUniX.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			this.cboUniX.FormattingEnabled = true;
			this.cboUniX.Items.AddRange(new object[] {
            "x1",
            "x2",
            "x3",
            "x4",
            ...
            "x7",
            "x8"});
			this.cboUniX.Location = new System.Drawing.Point(334, 34);
			this.cboUniX.Name = "cboUniX";
			this.cboUniX.Size = new System.Drawing.Size(87, 20);
			this.cboUniX.TabIndex = 1;
			// 
			// label1
			// 
			...
			this.Controls.Add(this.cboUniX);
		...
		private System.Windows.Forms.ComboBox cboUniX;
